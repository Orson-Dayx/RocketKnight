...
void PlayerCreate()
{
    ...
    rect.rect.w = sprite.rect.w * sprite.scale.x()*0.75;
    rect.rect.h = sprite.rect.h * sprite.scale.y()*0.75;
    rect.rect.x = sqrt(sprite.rect.w * sprite.scale.x()*0.25);
    rect.rect.y = sqrt(sprite.rect.h * sprite.scale.y()*0.25);
