...
void GridCreate()
{
    ...
    auto result = map.load_file("resources/tiled_files/Arena_map.tmx");
    if (!result)
    {
    ...
    }
    {
        ...
        registry.assign<CollisionLayer>(id, LayersID::BACKGROUND);
    ...
    }
    {
        ...
        registry.assign<Position>(id);
        registry.assign<TileGridCollider>(id);
        registry.assign<CollisionLayer>(id, LayersID::ENVIRONMENT);
        registry.assign<Active>(id);
    ...
    {
        auto id = registry.create();
        auto &tilegrid = registry.assign<TileGrid>(id, map, &tileset, 4);
        registry.assign<Position>(id);
        registry.assign<TileGridCollider>(id);
        registry.assign<CollisionLayer>(id, LayersID::TRAPS);
        registry.assign<Active>(id);
